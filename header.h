...
/*   Updated: 2025/08/27 21:04:44 by ahabbard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_block_point	*ft_malloc_block(char *board, int *number_block, int *length_board);
// edge
void			ft_update_edge(int *edge, t_block_point *block_point,
					int board_size, int number_block);
...
int				*ft_memo_max_block(int pos_y, int pos_x, int max_size,
					int *memo_max_block);
//final loop
int	*ft_an_edge_is_all_you_need(char *name_of_file,int board_size, int *memo_max_block);
